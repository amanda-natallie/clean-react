...
type SutTypes = {
  ...
  httpPostClientSpy: HttpPostClientSpy<AuthenticationParams, AccountModel | undefined>
}
...
const makeSut = (url: string = fakerUrl): SutTypes => {
  const httpPostClientSpy = new HttpPostClientSpy<AuthenticationParams, AccountModel | undefined>()
